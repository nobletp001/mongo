...
export default function BreakingNewsCategory() {
  ...
  useEffect(() => {
    Axios.get(baseUrl + "/wp-json/wp/v2/posts/?categories=3&per_page=9", {
      params: { page: page }
    }).then((response) => {
...
<Helmet>
            <meta charSet="utf-8" />
            <title>Bongo Music | Latest Breaking News about Igbo's 
            Around The World</title>

            <meta name="keywords" content="Breacking News, Download Atinga Woma, Mike Ejeagha, 
            ...
            <meta
                name="description"
                content="Get the latest breaking news on all igbos Activities, 
                Festival, Events, Happenings, and Trending gist across the world"
            />
            <meta 
            name="title" 
            content="Bongo Music | Latest Breaking News about Igbo's 
            Around The World" />
            ...
            <meta property="og:description"
                content="Bongo Music | Get Latest Breaking News about Igbo's 
            ...
            <meta property="twitter:url" content="https://bongomusic.com.ng/breakingnews"/>
            <meta property="twitter:title" content="Bongo Music | Get Latest Breaking News about Igbo's 
            Around The World"/>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" style={{ borderRadius: '10px', backgroundColor: '#FFC107'}}>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                  <li class="nav-item">
                    <a class="nav-link"  style={{ color: '#000'}} href="/breakingnews">Breaking News</a>
                  </li>
                  <li class="nav-item">
    ...
    <div className="py-5">
      <h1 className="display-5 fw-bold text-white">Latest breaking News</h1>
      <div className="col-lg-6 mx-auto">
        <p className="fs-5 mb-4">Get the latest breaking news on all igbos Activities, Festival, Events, Happenings, and Trending gist across the world</p>
      </div>
    </div>
