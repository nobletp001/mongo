...
export default function HistoryCategory() {
 ...
 <Helmet>
            ...
            <meta
                name="description"
                content="We bring daily history about the Igbo's and 
                their cultural life. Stay up-to-date with the
                 history of the igbo Tribe."
            />
            <meta 
            name="title" 
            content="Bongo Music | Today's History about Igbo's 
            Around The World" />
             <meta property="og:type" content="website" />
            <meta property="og:url" content="https://bongomusic.com.ng/history" />
          


            <meta property="og:description"
                content="Get Today's History about Igbo's 
            Around The World, We bring daily history about the Igbo's and 
                their cultural life. Stay up-to-date with the
                 history of the igbo Tribe." />
            <meta property="og:image" content="https://bongomusic.com.ng/logo.png" />

            <meta property="twitter:card" content="summary_large_image"/>
            <meta property="twitter:url" content="https://bongomusic.com.ng/history"/>
            <meta property="twitter:title" content="Bongo Music | Get Today's History about Igbo's 
            Around The World"/>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" style={{ borderRadius: '10px', backgroundColor: '#FFC107'}}>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" style={{ color: '#000'}} href="/history">History</a>
                  </li>
                  <li class="nav-item">
    ...
    <div className="py-5">
      <h1 className="display-5 fw-bold text-white">Welcome to Today's History</h1>
      <div className="col-lg-6 mx-auto">
        <p className="fs-5 mb-4">We bring daily history about the Igbo's and their cultural life. Stay up-to-date with the history of the igbo Tribe.</p>
      </div>
    </div>
