...
export default function FashionCategory() {
  ...
  useEffect(() => {
    Axios.get(baseUrl + "/wp-json/wp/v2/posts/?categories=20&per_page=9", {
      params: { page: page }
    }).then((response) => {
...
<Helmet>
            <meta charSet="utf-8" />
            <title>Bongo Music | Trending Fashion News about Igbo's 
            Around The World</title>
            <meta
                name="description"
                content="Get trending Igbo Fashion making name in the fashion industry. You will be getting update on latest 
        Fashion News of all Igbo celebrities, Designers in Local and international community."
            />

            <meta name="keywords" content="Fashion, Download Atinga Woma, Mike Ejeagha, 
            ...
            <meta 
            name="title" 
            content="Bongo Music | Trending Fashion News about Igbo's 
            Around The World" />
             <meta property="og:type" content="website" />
            <meta property="og:url" content="https://bongomusic.com.ng/fashion" />
          


            <meta property="og:description"
                content="Get Trending Fashion News about Igbo's 
            Around The World, Get trending Igbo Fashion making name in the fashion industry. You will be getting update on latest 
        Fashion News of all Igbo celebrities, Designers in Local and international community." />
            <meta property="og:image" content="https://bongomusic.com.ng/logo.png" />

            <meta property="twitter:card" content="summary_large_image"/>
            <meta property="twitter:url" content="https://bongomusic.com.ng/fashion"/>
            <meta property="twitter:title" content="Bongo Music | Get Latest Event News about Igbo's 
            Around The World"/>
    ...
    <div className="py-5">
      <h1 className="display-5 fw-bold text-white">Trending fashion News</h1>
      <div className="col-lg-6 mx-auto">
        <p className="fs-5 mb-4">Get trending Igbo Fashion making name in the fashion industry. You will be getting update on latest 
        Fashion News of all Igbo celebrities, Designers in Local and international community. </p>
      </div>
    </div>
