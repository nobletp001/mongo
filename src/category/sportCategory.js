...
export default function SportCategory() {
  ...
  useEffect(() => {
    Axios.get(baseUrl + "/wp-json/wp/v2/posts/?categories=13&per_page=9", {
      params: { page: page }
    }).then((response) => {
...
<Helmet>
            <meta charSet="utf-8" />
            <title>Bongo Music | Latest Sport News about Igbo's 
            Around The World</title>

            <meta name="keywords" content="Sport, Download Atinga Woma, Mike Ejeagha, 
            ...
            <meta
                name="description"
                content="Follow up on Sport News about Igbo players making name in the sport industry. We will be updating you on latest 
        Sport News of all Igbo Players in Local and international career."
            />
            <meta 
            name="title" 
            content="Bongo Music | Latest Sport News about Igbo's 
            Around The World" />
             <meta property="og:type" content="website" />
            <meta property="og:url" content="https://bongomusic.com.ng/sport" />
          


            <meta property="og:description"
                content="Latest Sport News about Igbo's 
            Around The World, Follow up on Sport News about Igbo players making name in the sport industry. We will be updating you on latest 
        Sport News of all Igbo Players in Local and international career." />
            <meta property="og:image" content="https://bongomusic.com.ng/logo.png" />

            <meta property="twitter:card" content="summary_large_image"/>
            <meta property="twitter:url" content="https://bongomusic.com.ng/sport"/>
            <meta property="twitter:title" content="Bongo Music | Latest Sport News about Igbo's 
            Around The World" />
    ...
    <div className="py-5">
      <h1 className="display-5 fw-bold text-white">Latest Sport News</h1>
