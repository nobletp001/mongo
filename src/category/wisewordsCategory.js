...
export default function WisewordsCategory() {
  ...
  useEffect(() => {
    Axios.get(baseUrl + "/wp-json/wp/v2/posts/?categories=12&per_page=9", {
      params: { page: page }
    }).then((response) => {
...
<Helmet>
            <meta charSet="utf-8" />
            <title>Bongo Music | Today's Wise Words about Igbo's 
            ...
            <meta
                name="description"
                content="We bring daily Wise Words about the Igbo's and their 
                cultural life. Stay up-to-date with the inspirational 
                words of the igbo Tribe."
            />
            <meta 
            name="title" 
            content="Bongo Music | Today's Wise Words about Igbo's 
            Around The World" />
             <meta property="og:type" content="website" />
            <meta property="og:url" content="https://bongomusic.com.ng/wisewords" />
          


            <meta property="og:description"
                content="Today's Wise Words about Igbo's 
            Around The World, We bring daily Wise Words about the Igbo's and their 
                cultural life. Stay up-to-date with the inspirational 
                words of the igbo Tribe." />
            <meta property="og:image" content="https://bongomusic.com.ng/logo.png" />

            <meta property="twitter:card" content="summary_large_image"/>
            <meta property="twitter:url" content="https://bongomusic.com.ng/wisewords" />
            <meta property="twitter:title" content="Bongo Music | Today's Wise Words about Igbo's 
            Around The World"/>
    ...
    <div className="py-5">
      <h1 className="display-5 fw-bold text-white">Today's Wise Words </h1>
      <div className="col-lg-6 mx-auto">
        <p className="fs-5 mb-4">We bring daily Wise Words about the Igbo's and their cultural life. Stay up-to-date with the inspirational words of the igbo Tribe.</p>
      </div>
    </div>
