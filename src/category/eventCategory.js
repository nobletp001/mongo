...
export default function BreakingNewsCategory() {
  ...
  useEffect(() => {
    Axios.get(baseUrl + "/wp-json/wp/v2/posts/?categories=10&per_page=9", {
      params: { page: page }
    }).then((response) => {
...
<Helmet>
            <meta charSet="utf-8" />
            <title>Bongo Music | Latest Event News about Igbo's 
            Around The World</title>

            <meta name="keywords" content="Event, Download Atinga Woma, Mike Ejeagha, 
            ...
            <meta
                name="description"
                content="Follow up on Igbo Event happening around the world, 
        we give you news about Igbo Festival, Cultural Day."
            />
            <meta 
            name="title" 
            content="Bongo Music | Latest Event News about Igbo's 
            Around The World" />
             <meta property="og:type" content="website" />
            <meta property="og:url" content="https://bongomusic.com.ng/events" />
          


            <meta property="og:description"
                content="Get Latest Event News about Igbo's 
            Around The World, Follow up on Igbo Event happening around the world, 
        we give you news about Igbo Festival, Cultural Day." />
            <meta property="og:image" content="https://bongomusic.com.ng/logo.png" />

            <meta property="twitter:card" content="summary_large_image"/>
            <meta property="twitter:url" content="https://bongomusic.com.ng/events"/>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" style={{ borderRadius: '10px', backgroundColor: '#FFC107'}}>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item ">
                    <a class="nav-link" style={{ color: '#000'}} href="/events" >Events</a>
                  </li>
                  <li class="nav-item">
    ...
    <div className="py-5">
      <h1 className="display-5 fw-bold text-white">Latest Event News</h1>
      <div className="col-lg-6 mx-auto">
        <p className="fs-5 mb-4">Follow up on Igbo Event happening around the world, 
        we give you news about Igbo Festival, Cultural Day.</p>
      </div>
    </div>
