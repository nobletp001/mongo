...
export default function BusinessCategory() {
  ...
  useEffect(() => {
    Axios.get(baseUrl + "/wp-json/wp/v2/posts/?categories=15&per_page=9", {
      params: { page: page }
    }).then((response) => {
  ...
  const handleNextPage = () => setPage(page < nrofpages ? page + 1 : nrofpages);
    ...
    return (
      <>
          ...
          <Helmet>
            <meta charSet="utf-8" />
            <title>Bongo Music | Latest Business News about Igbo's 
            Around The World</title>

            <meta name="keywords" content="Business, Download Atinga Woma, Mike Ejeagha, 
            ...
            <meta
                name="description"
                content="Follow up on Business News about Igbo Multi-billion Dollar market 
                in the business sector. We will be updating you on latest 
                Business News of all Igbo Business Men & Women in Local and international community."
            />
            <meta 
            name="title" 
            content="Bongo Music | Latest Business News about Igbo's 
            Around The World" />
             <meta property="og:type" content="website" />
            <meta property="og:url" content="https://bongomusic.com.ng/business" />
          


            <meta property="og:description"
                content="Get Latest Business News about Igbo's 
            Around The World, Follow up on Business News about Igbo 
            Multi-billion Dollar market in the business sector. We will be updating you on latest 
                Business News of all Igbo Business Men & Women in Local and international community." />
            <meta property="og:image" content="https://bongomusic.com.ng/logo.png" />

            <meta property="twitter:card" content="summary_large_image"/>
            <meta property="twitter:url" content="https://bongomusic.com.ng/business"/>
            <meta property="twitter:title" content="Get Latest Business News about Igbo's 
            Around The World"/>
        ...
        <nav class="navbar navbar-expand-lg navbar-light" style={{ borderRadius: '10px', backgroundColor: '#FFC107'}}>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" style={{ color: '#000'}}  href="/business">Business</a>
                  </li>
                  <li class="nav-item ">
    ...
    <div className="py-5">
      ...
      <div className="col-lg-6 mx-auto">
        <p className="fs-5 mb-4">Follow up on Business News about Igbo Multi-billion Dollar market in the business sector. We will be updating you on latest 
        Business News of all Igbo Business Men & Women in Local and international community. </p>
      </div>
    </div>
