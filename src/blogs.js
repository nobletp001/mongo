...
export default function App() {
  ...
  useEffect(() => {
    Axios.get(baseUrl + "/wp-json/wp/v2/posts/?per_page=6", {
      params: { page: page }
    }).then((response) => {
  ...
  return (
    ...
    <Helmet>
            <meta charSet="utf-8" />
            <title>Bongo Music Latest Igbo News | Get Latest News about Sport , 
            History, Business and Breaking News about Igbo's 
            ...
            <meta
                name="description"
                content="Get Latest Igbo News, Articles, History, 
                Event, Entertainment, Sport, Download Atinga Woma, Bogar Bongo, 
                Bongo Apostle, Bruno, Nwa Naze Man, 
                Eluigwe Nwa Ugorji, Chinedum, Chimuanya, Obisco, 
                Dr Sir Foreigner, Chima Eke."
            />
            <meta 
            name="title" 
            content="Bongo Music Latest Igbo News | Get Latest News about Sport , 
            History, Business and Breaking News about Igbo's 
            Around The World" />
             <meta property="og:type" content="website" />
            <meta property="og:url" content="https://bongomusic.com.ng/blogs" />
          


            <meta property="og:description"
                content="Get Latest News about Sport , 
            History, Business and Breaking News about Igbo's 
            Around The World, Download Atinga Woma, Mike Ejeagha, 
                Sewa Sewa, Chijioke, Ayaka Ozubulu, Amadi Ndo, Akia Moses, 
                Empire Bongo, Ajibo Machine,Sunny Bobo, Holy Man, Chinedu Okere, 
                Bogar Bongo, Bongo Apostle, KC Voice, Ikenna Boy, Kugba Nwaeze, 
                Bruno, Nwa Naze Man, Eluigwe Nwa Ugorji, Chimuanya and Chinedum, 
                Chimuanya, Obisco, Shama Melody, KoKo Nwa Jesus, Dr Sir Foreigner, 
                ND Stanley Naorom, Saro Wiwa, Chima Eke" />
            <meta property="og:image" content="https://bongomusic.com.ng/logo.png" />

            <meta property="twitter:card" content="summary_large_image"/>
            <meta property="twitter:url" content="https://bongomusic.com.ng/blogs"/>
            <meta property="twitter:title" content="Bongo Music Latest Igbo News | Get Latest News about Sport , 
            History, Business and Breaking News about Igbo's 
            Around The World"/>
            <meta property="twitter:description"
                content="Get Latest News about Sport , 
            History, Business and Breaking News about Igbo's 
            Around The World. Get Latest Igbo News, Download Atinga Woma, Mike Ejeagha, 
                Sewa Sewa, Chijioke, Ayaka Ozubulu, Amadi Ndo, Akia Moses, Empire Bongo,
                 Ajibo Machine,Sunny Bobo, Holy Man, Chinedu Okere, Bogar Bongo, 
                 Bongo Apostle, KC Voice, Ikenna Boy, Kugba Nwaeze, Bruno, Nwa Naze Man, 
                 Eluigwe Nwa Ugorji, Chimuanya and Chinedum, Chimuanya, Obisco, Shama Melody, 
                 KoKo Nwa Jesus, Dr Sir Foreigner, ND Stanley Naorom, Saro Wiwa, Chima Eke"/>
  ...
  <div id="advanced-features" className="bg-dark text-secondary px-4 py-5 text-center ">
      ...
      <br />
        ...
        <nav class="navbar navbar-expand-lg navbar-light" style={{ borderRadius: '10px', backgroundColor: '#FFC107'}}>
            ...
            <div className="py-5">
      <h1 className="display-5 fw-bold text-white">Latest Igbo Blog News</h1>
        ...
        {posts &&
          ...
          posts.map((post, index) => {
           ...
           <img  className="postimg" src={post.better_featured_image.source_url} alt="{post.title.rendered}" />
                ...
                <Link to={`/posts/${post.id}`}><h5 className="card-title" 
                dangerouslySetInnerHTML={{ __html: post.title.rendered}}></h5></Link>
                <p className="card-text">{renderHTML(post.excerpt.rendered)}</p>
                <a href="#" className="btn btn-primary blg">Read More</a>
              </div>
        </div>  
        </li> 
            );
